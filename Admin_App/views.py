...
def allnews(request):
    news = BreakingNews.objects.all()

    return render(request, 'Admin_App/news.html', context={'news': news})


def detail_news(request,id):
    news = BreakingNews.objects.get(id=id)

    return render(request, 'Admin_App/news_detail.html', context={'news': news})
